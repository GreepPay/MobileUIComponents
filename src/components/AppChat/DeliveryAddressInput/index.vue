      ...
      <div class="p-4 pb-8">
        ...
        <div class="flex items-center justify-between mb-6">
          <div class="flex items-center space-x-2">
            ...
            <app-header-text class="text-lg text-gray-800">{{
              addressType
            }}</app-header-text>
          </div>
          <app-button
            ...
            icon-only
            @click="handleCancel"
            custom-class="!p-2 hover:bg-gray-100"
          >
            <template #icon>
        ...
        <app-form-wrapper :parent-refs="formRefs">
          <div class="space-y-4">
            ...
            <div class="space-y-2">
              <app-normal-text
                class="block text-sm font-medium text-gray-700 mb-1"
                >Google Maps Location Link</app-normal-text
              >
              <app-text-field
                :has-title="false"
                type="url"
              ...
              <app-normal-text class="text-xs text-gray-500">
                💡 Open Google Maps, find your location, tap "Share" and copy
                the link
              </app-normal-text>
            </div>
            ...
            <div class="space-y-2">
              <app-normal-text
                class="block text-sm font-medium text-gray-700 mb-1"
                >Address Details</app-normal-text
              >
              <app-text-field
                :has-title="false"
                type="text"
            ...
            <!-- Address preview -->
            <div
              v-if="selectedArea && (mapsLink || addressDetails)"
              class="bg-blue-50 p-3 rounded-lg border border-blue-200"
            >
              <app-normal-text class="text-sm font-medium text-blue-800 mb-1"
                >{{ addressType }}:</app-normal-text
              >
              <app-normal-text class="text-sm text-blue-700"
                >📍 {{ selectedArea }}</app-normal-text
              >
              ...
              <app-normal-text
                ...
                >📝 {{ addressDetails }}</app-normal-text
              >
            </div>
          </div>
        </app-form-wrapper>
  ...
  setup(props, { emit }) {
    ...
    const confirmAddress = () => {
      ...
      if (!mapsLink.value && !addressDetails.value) {
        console.error(
          "Please provide either a Google Maps link or address details."
        );
        return;
      }

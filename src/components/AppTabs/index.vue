  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      const selectTab = (key: string) => {
        if (props.disableTabChange) return
        activeTab.value = key
      ...
      const getTabClass = (tabKey: string) => {
        ...
        if (props.type === "badge") {
          return [
            baseClass,
            activeTab.value === tabKey
              ? "!font-[500] !text-white !bg-black rounded-full !border-[1.5px] !border-black"
        ...
        if (props.type === "outlined") {
          return [
            baseClass,
            activeTab.value === tabKey
              ? "!font-medium !text-black border-[1.5px] !border-black rounded-full !border-[1.5px] !border-black"
